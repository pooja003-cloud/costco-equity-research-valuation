...
- **Unlevered FCF, FY2025–FY2029:** 5,992 / 6,473 / 6,757 / 7,141 / 7,573. FY2025 is a stub: only 77% of the year is counted, the period after 24 Nov 2024.
...
- **WACC 8.38%:**
  - Rf 4.58% (10y UST);
  - Blume-adjusted beta 0.89 (raw 0.84, 60-month regression);
  - ERP 4.33% (Damodaran, Jan 2025);
  - pre-tax cost of debt 5.15%;
  - weights: equity 98.5%, debt 1.5%.
...
- **Our result:**
  ...
  - implied exit multiple 9.9× FY2029 EBITDA;
